...
if is_service_enabled q-svc; then
    ...
    ### 
    iniset $Q_CONF_FILE DEFAULT quantum_plugin_config /etc/quantum/plugins/ryu/ryu.ini
    iniset $Q_CONF_FILE DEFAULT allow_overlapping_ips True
    ###
...
if is_service_enabled quantum; then
    ...
    #fi
    ###
    NOVA_VIF_DRIVER="nova.virt.libvirt.vif.LibvirtOpenVswitchVirtualPortDriver "
...
if is_service_enabled n-cpu; then
    ###
    add_nova_opt "novnc_enabled=true"
    add_nova_opt "novncproxy_port=6080"
    ###
...
###VNCSERVER_LISTEN=${VNCSERVER_LISTEN=127.0.1.1}
